...
private ConexionPostgreSQL conexion;
	...
	private static final String INSERT_ODONTOLOGO_SQL = "INSERT INTO odontologo	(username, pass, user_id, email, telefono, consultorio) VALUES (?,?,?,?,?,?);";
	...
	public void insert(Odontologo odontologo) throws SQLException{
		try {
			...
			preparedStatement.setInt(3, odontologo.getUser_id());
			preparedStatement.setString(4, odontologo.getEmail());
			preparedStatement.setString(5, odontologo.getTelefono());
			preparedStatement.setString(6, odontologo.getConsultorio());
			conexion.execute();
