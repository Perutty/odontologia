...
private ConexionPostgreSQL conexion;
	...
	private static final String INSERT_PROCESO_SQL = "INSERT INTO proceso(username, email, pass) VALUES (?,?,?);";
	private static final String UPDATE_PROCESO_SQL = "UPDATE proceso SET username = ?,email = ?, pass = ? WHERE id = ?;";
	private static final String DELETE_PROCESO_SQL = "DELETE FROM proceso WHERE id = ?;";
	private static final String SELECT_PROCESO_BY_COD = "SELECT * FROM proceso WHERE cedula = ?;";
	...
	public List<Proceso> selectAll(){
		...
		try {
			...
			while(rs.next()) {
				...
				procesos.add(new Proceso(name, fecha, value, observation,cod));
			}
